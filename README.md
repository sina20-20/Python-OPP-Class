...
-------------------------------check_pass_fail() method is defined inside the Student class
...
Whenev define methods for a class, we need to use self as the first parameter. This self represents the object calling it. In our example, self refers to the student1 object, and self.marks refers to the marks attribute of student1.
